...
export class HorariosComponent
  ...
  private franjasDisponibles:
    TimeSlotResponseDTO[] = [];

  private clasesActuales:
    ScheduleResponseDTO[] = [];

  private nombresCursoCache =
  ...
  idGeneracionPublicadaActual:
    number | null = null;

  borrador:
    ScheduleResponseDTO[] | null = null;
  ...
  get existeHorarioAnteriorParaBorrador():
    boolean {
    return (
      this.idGeneracionPublicadaActual !==
      null
  ...
  private cargarHorarioEstudiante():
    void {
    ...
    this.horariosService
      ...
      .subscribe({
        ...
        error: err => {
          ...
          console.error(
            'Error cargando horario por curso:',
            err
          );
    ...
    this.horariosService
      ...
      .subscribe({
        ...
        error: err => {
          ...
          console.error(
            'Error cargando horario del docente:',
            err
          );
  ...
  private construirGrilla(
    ...
    for (
      const clase of clasesOrdenadas
    ) {
  ...
  cambiarPaginaConflictos(
    pagina: number
  ): void {

    this.paginaActualConflictos =
      pagina;
  }
  ...
  private cargarGeneracionesPendientes():
    void {
  ...
  private guardarGeneracionesPendientes():
    void {
  ...
  private cargarGeneracionesPublicadas():
    void {
  ...
  private guardarGeneracionesPublicadas():
    void {
  ...
  private guardarHorariosPublicados():
    void {

...
export class InicioComponent {
  ...
  enviarSoporte(): void {
    ...
    this.soporteService
      .enviarSoporte({
        senderName: formulario.nombreRemitente.trim(),
        senderEmail: formulario.emailSoporte.trim(),
        subject: formulario.asuntoSoporte.trim(),
  ...
  toggleFaq(index: number): void {
    this.preguntasFrecuentes[index].abierta =
      !this.preguntasFrecuentes[index].abierta;
  }
}